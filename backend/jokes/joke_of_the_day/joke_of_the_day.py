...
def get_latest_joke_of_the_day() -> Optional[JokeOfTheDay]:
    """
    Retrieve the latest joke of the day.

    Returns:
        Joke: The most recent joke, or None if no joke exists.
    """
    try:
        return JokeOfTheDay.objects.select_related("joke").latest("created_at")
